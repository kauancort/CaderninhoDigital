...
public class ProdutoController {
    ...
    @PostMapping
    public ResponseEntity<ProdutoResponseDTO> criar(@UsuarioIdAutenticado Long usuarioId, @RequestBody @Valid ProdutoRequestDTO dto) {
        return ResponseEntity.status(HttpStatus.CREATED).body(produtoService.criar(usuarioId, dto));
    }

    @GetMapping
    public ResponseEntity<List<ProdutoResponseDTO>> listar(@UsuarioIdAutenticado Long usuarioId) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ProdutoResponseDTO> buscar(@UsuarioIdAutenticado Long usuarioId, @PathVariable Long id) {
        return ResponseEntity.ok(produtoService.buscar(usuarioId, id));
    }

    @PutMapping("/{id}")
    public ResponseEntity<ProdutoResponseDTO> atualizar(@UsuarioIdAutenticado Long usuarioId, @PathVariable Long id, @RequestBody @Valid ProdutoRequestDTO dto) {
