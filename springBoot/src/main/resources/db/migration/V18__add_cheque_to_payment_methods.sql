...
ALTER TABLE compras_materias_primas DROP CONSTRAINT IF EXISTS ck_compras_forma_pagamento;
ALTER TABLE compras_materias_primas ADD CONSTRAINT ck_compras_forma_pagamento CHECK (forma_pagamento IS NULL OR forma_pagamento IN ('BOLETO', 'CARTAO', 'DINHEIRO', 'OUTRO', 'PIX', 'CHEQUE'));
